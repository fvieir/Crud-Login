                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle menu" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="../Public/imagens/logo.png" class="rounded-circle" height="30" width="30" style="margin-right: 10px;"><span class="d-none d-md-inline">Usuário</span>  
                        </a>
                    ...
                    { 
                      ...
                      foreach ($dados as $result) {
                                      ...
                                      echo"<td class='text-center'>"
                                          ...
                                          ."    <a href='../OrdemServicoController/Visualizar/{$result['CODOR']}' class='btn btn-sm btn-outline-primary'>Visualizar"
                                              ."</a>"
                                              ."<a href='editar_os.php?id={$result['CODOR']}' class='btn btn-sm btn-outline-warning'>Editar"
                                              ."</a>"
                                              ."<a href='../OrdemServicoController/Apagar/{$result['CODOR']}' class='btn btn-sm btn-outline-danger'>Apagar</a>
                                          </span>"
